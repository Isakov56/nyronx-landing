        ...
        <div className="lg:col-span-5 lg:sticky lg:top-24 lg:self-start">
          ...
          <div className="inline-flex items-center gap-1 p-1 bg-white rounded-full border border-brand-forest/10">
            <button
              ...
              className={`px-5 py-2.5 rounded-full text-[15px] font-semibold transition-colors ${
                currency === 'UZS'
        ...
        <div className="lg:col-span-7 grid sm:grid-cols-2 gap-5 lg:gap-6">
          {plans.map((plan) => {
            ...
            return (
              <article
                key={plan.name}
                className={`group rounded-[28px] p-7 lg:p-8 border transition-all duration-300 flex flex-col ${
                  dark
              ...
              >
                ...
                <h3
                  className={`text-[32px] font-bold mb-3 leading-[1.25] tracking-tight ${
                    dark ? 'text-white' : 'text-[#1A1D1F]'
                  }`}
                >
                  {plan.name}
                </h3>
                <p
                  className={`text-lg mb-6 flex-1 leading-[1.65] ${
                    dark ? 'text-white/80' : 'text-brand-slate'
                  }`}
                >
                  {plan.description}
                </p>
                ...
                <div className="mb-6">
                  <span
                    className={`text-[40px] lg:text-[48px] font-bold tracking-tight ${
                ...
                <a
                  href="#contact"
                  className={`inline-flex w-full items-center justify-center gap-2 px-6 py-3.5 rounded-full text-lg font-bold transition-colors mt-auto ${
                    dark
